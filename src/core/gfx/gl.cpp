...
namespace gfx
{
    void init()
    {
        ...
        {
            logger.warn("Failed to initialize GLAD");
        }
        else
        {
    ...
    void Pipeline::link()
    {
        ...
        if (!success)
        {
            ...
            logger.error("Pipeline linking failed: {}", std::string(infoLog));
        }
    }
    ...
    Framebuffer::Framebuffer()
    {
        ...
        // GL_CALL(glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, 800, 600));
